      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Bằng cách gọi API sang NTX, truyền json param vào body theo thông số mô tả trong mục parameters. API này nếu KH lấy theo location của KH',
